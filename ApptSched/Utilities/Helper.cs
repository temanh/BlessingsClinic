...
namespace ApptSched.Utilities
{
    public static class Helper
    {
        ...
        //string messages for data after submission
        ...
        public static string appointmentConfirmed = "Appointment Confirmed! See you soon";
        public static string appointmentError = "Error while confirming appointment. Please try again!";
        ...
        public static List<SelectListItem> GetRolesForDropDown(bool isAdmin)
        {
            if (isAdmin)
            {
                //register Admin account, to make more Admin
